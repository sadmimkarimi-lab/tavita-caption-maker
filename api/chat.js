...
const BLOCKED_PHRASES = [
  ...
  /(کپشن|متن|پست).*(ضد|انتقاد).*(جمهوری\s+اسلامی|نظام|حکومت)/,
];
...
- تولید هرگونه محتوای سیاسی، تحلیلی، موافق یا مخالف حکومت‌ها، احزاب، جریان‌ها، انتخابات و به‌طور خاص مرتبط با جمهوری اسلامی ایران و نظام سیاسی
  ممنوع است. در این موارد فقط باید بنویسی:
...
- اگر کاربر درخواستی نامناسب، غیراخلاقی، سیاسی یا خلاف ارزش‌های انسانی مطرح کرد:
